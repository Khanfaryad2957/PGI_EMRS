    ...
    try {
      ...
      const proformaResult = await db.query(
        `INSERT INTO clinical_proforma (
         ...
         requires_adl_file, adl_reasoning, adl_file_id, prescriptions
        ) VALUES (
        ...
        [
          patient_id, filled_by, visit_date, visit_type, room_no, assigned_doctor,
          informant_present, 
          allProformaData.nature_of_information, 
          allProformaData.onset_duration, 
          allProformaData.course,
          allProformaData.precipitating_factor, 
          allProformaData.illness_duration, 
          allProformaData.current_episode_since, 
          allProformaData.mood,
          allProformaData.behaviour, 
          allProformaData.speech, 
          allProformaData.thought, 
          allProformaData.perception, 
          allProformaData.somatic, 
          allProformaData.bio_functions,
          allProformaData.adjustment, 
          allProformaData.cognitive_function, 
          allProformaData.fits, 
          allProformaData.sexual_problem, 
          allProformaData.substance_use,
          allProformaData.past_history, 
          allProformaData.family_history, 
          allProformaData.associated_medical_surgical, 
          allProformaData.mse_behaviour,
          allProformaData.mse_affect, 
          allProformaData.mse_thought, 
          allProformaData.mse_delusions, 
          allProformaData.mse_perception,
          allProformaData.mse_cognitive_function, 
          allProformaData.gpe, 
          allProformaData.diagnosis, 
          allProformaData.icd_code, 
          allProformaData.disposal,
          allProformaData.workup_appointment, 
          allProformaData.referred_to, 
          allProformaData.treatment_prescribed, 
          doctor_decision,
           requires_adl_file, 
          allProformaData.adl_reasoning, 
