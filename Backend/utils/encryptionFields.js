...
//     'serial_no',
//     'file_no',
//     // Note: unit_days is not encrypted - it must match database constraint values ('mon', 'tue', 'wed', 'thu', 'fri', 'sat')
 ...
 * and automatically decrypted when fetched for display in the UI.
 * 
 * NOTE: Numeric fields (INTEGER, NUMERIC, DECIMAL) and constrained fields (with CHECK constraints)
 * cannot be encrypted as they need to maintain their data type and validation in the database.
 */

module.exports = {
  // Patient (registered_patient table) - Sensitive personal information
  patient: [
    // Step 1 - Quick Entry Fields (Basic Information)
    'cr_no',
    'name',
    'mobile_no',
    'father_name',
    ...
    // Step 1 - First Visit Information
    // Note: 'seen_in_walk_in_on' and 'worked_up_on' are DATE - cannot encrypt
    'psy_no',
    'special_clinic_no',
    'age_group',
    ...
    'head_name',
    // Note: head_age is INTEGER - cannot encrypt
    'head_relationship',
    'head_education',
    'head_occupation',
    // Note: head_income is NUMERIC - cannot encrypt
    
    // Step 2 - Distance & Mobility
    'distance_from_hospital',
    'mobility',
    ...
    // Additional Address Fields (if present in schema)
    'address_line_2',
    'present_address',
    'present_address_line_1',
    'present_address_line_2',
    ...
    // Additional Fields
    'assigned_doctor_name',
    // Note: 'assigned_doctor_id' is INTEGER - cannot encrypt
    'assigned_room',
    
    // Additional Occupation & Education (extended fields)
    'actual_occupation',
    'education_level',
    'completed_years_of_education',
    // Note: patient_income and family_income are NUMERIC - cannot encrypt
  ...
  clinicalProforma: [
    ...
    'room_no',
    // Note: 'assigned_doctor' is INTEGER - cannot encrypt
    
    // Step 2 - Clinical Proforma - Informant
    'nature_of_information',
    'onset_duration',
    'course',
    'precipitating_factor',
    ...
    // Step 2 - Complaints / History of Presenting Illness
    'mood',
    'behaviour',
    'speech',
    'thought',
    ...
    // Step 2 - Diagnosis & Management
    'diagnosis',
    'icd_code',
    // Note: doctor_decision is not encrypted - constrained to 'simple_case' or 'complex_case'
    
    // Additional Management Fields
    'disposal',
    // Note: 'workup_appointment' is DATE - cannot encrypt
    'referred_to',
    'treatment_prescribed',
    'adl_reasoning',
  ...
  // ADL File (Complex Case - Step 3) - All detailed medical and personal history
  adlFile: [
    // History
    'history_narrative',
    'history_specific_enquiry',
    ...
    // Illness Details (if separate from history)
    'onset_duration',
    'precipitating_factor',
    'course',
    ...
    'family_history_father_occupation',
    'family_history_father_personality',
    // Note: family_history_father_deceased is BOOLEAN - cannot encrypt
    'family_history_father_death_date',
    'family_history_father_death_cause',
    ...
    'family_history_mother_occupation',
    'family_history_mother_personality',
    // Note: family_history_mother_deceased is BOOLEAN - cannot encrypt
    'family_history_mother_death_date',
    'family_history_mother_death_cause',
    ...
    // Family History of Mental Illness (general)
    'family_history',
